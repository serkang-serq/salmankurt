...
export default function Navbar() {
  ...
  // Menü linkleri (Medya ve Galeri çıkarıldı, sadece ana sütunlar var)
  const links = [
    { name: "Home", href: "/" },
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex justify-between items-center h-12">
        
        {/* SOL: LOGO */}
        <Link 
          href="/" 
          onClick={() => setIsOpen(false)}
          className="z-[110] text-2xl md:text-3xl font-black font-[family-name:var(--font-montserrat)] tracking-tighter text-white flex items-center"
        >
        ...
        {/* MOBİL: HAMBURGER BUTONU (Sadece mobilde görünür) */}
        <button 
          className="lg:hidden z-[110] flex flex-col justify-center items-center gap-1.5 p-2 w-10 h-10 outline-none"
        ...
        {/* MOBİL: AÇILIR MENÜ (Sadece butona basınca aşağı kayar) */}
        <div 
          className={`fixed inset-0 bg-[#0B2341] flex flex-col items-center justify-center gap-8 transition-transform duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] lg:hidden z-[100] ${
